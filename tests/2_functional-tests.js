...
suite('Functional Tests', () => {
    ...
    test('Solve a puzzle with invalid characters: POST request to /api/solve', (done) => {
        chai
            ...
            .send({
                puzzle:
                    '1.5..2.84..63.12.7.2..5.....9..1....8.2.h674.3.7.2..9.47...8..1..16....926914.37.'
            })
            .end((err, res) => {
                assert.equal(res.status, 200);
    ...
    test('Solve a puzzle with incorrect length: POST request to /api/solve', (done) => {
        chai
            ...
            .send({
                puzzle:
                    '1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.8'
            })
            .end((err, res) => {
                assert.equal(res.status, 200);
                assert.equal(
    ...
    test('Check a puzzle placement with invalid characters: POST request to /api/check', (done) => {
        chai
            ...
            .send({
                puzzle:
                    '1.5..2.84..63.12.7.2..5.....9..1h...8.2.3674.3.7.2..9.47...8..1..16....926914.37.',
                coordinate: 'A2',
                value: '3',
            })
            .end((err, res) => {
    ...
    test('Check a puzzle placement with incorrect length: POST request to /api/check', (done) => {
        chai
            ...
            .send({
                puzzle:
                    '1.5..2.84..63.12.7.2.2.5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.',
                coordinate: 'A2',
                value: '3',
            })
            .end((err, res) => {
    ...
    test('Check a puzzle placement with invalid placement value: POST request to /api/check', (done) => {
        chai
            .request(server)
            .post('/api/check')
            .send({ puzzle: validPuzzle, coordinate: 'A2', value: 'L' })
            .end((err, res) => {
                assert.equal(res.status, 200);

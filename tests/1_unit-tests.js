...
suite('Unit Tests', () => {
    suite('solver tests', () => {
        ...
        test('Logic handles a puzzle string with invalid characters (not 1-9 or .) ', function (done) {
            let inValiPuzzle =
                '1.5..2.84..63.12.7.2..5.....9..1....8.2.3g674.3.7.2..9.47...8..1..16....926914.37.'
            assert.equal(solver.completeSudoku(inValiPuzzle), false);
            done();
        });

        test('Logic handles a puzzle string that is not 81 characters in length', function (done) {
            let inValidPuzzle =
                '1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.4442..9.47...8..1..16....926914.37.8'
        ...
        test('Logic handles a valid region (3x3 grid) placement', function (done) {
            assert.equal(
                solver.checkRegionPlacement(validPuzzle, 'A', '2', '9'),
                true
            );
            done();
        });
